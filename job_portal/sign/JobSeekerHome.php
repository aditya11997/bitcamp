 		...
 		<h1 style="display: inline-block;color: white;text-align: center;position:absolute;float: center;left:50%;font-size:40px;" class="text-uppercase">Jobizza</h1>
		  ...
		  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		    <div class="navbar-nav">
		      ...
		      <a href="" class="nav-item nav-link" style="position:absolute;right:80px;color: white;font-weight: bold;font-family: Helvetica;color: color: #FF5733" data-toggle="popover" title="Popover Header" data-content="Some content inside the popover"><?php echo $username; ?>
		      
		      </a>
		      <a href="logout.php" class="nav-item nav-link" style="position:absolute;right:20px;color: white;font-weight: bold;font-family: Helvetica;color: color: #FF5733" data-toggle="popover" title="Popover Header" data-content="Some content inside the popover">|Logout</a>
			...
			<div class="jumbotron container-fluid">
			  <h1 class="display-3" style = "text-align: center;">Hey! There.....</h1>
			</div>
		...
		<div class="col-sm-12">
			<div class="card" class="card" style="width: 20rem;positive:relative;left:40%;background-color:#FECF72;color:#C70039">
			  ...
			  php
			    ...
			    <h5 class="card-text" id="jobLocation">'.'<b>Description -</b>'.$jobLocation.'<?php echo $job_title; ?></h5>
